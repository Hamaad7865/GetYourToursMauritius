 ...
 * tests/integration/schema.test.ts checks the same rule against the APPLIED schema's pg_enum, for
 * this enum and for `booking_status` / `payment_state` alongside it.
 */
