...
export const AREAS_RAW: AreaContent[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Play a round on The Legend or The Links, the two championship courses right on the coast at Constance Belle Mare Plage, or further afield at Anahita and Île aux Cerfs Golf Club',
      ...
      'Cool off at Splash n Fun Leisure Park, a pirate-themed water park on Coastal Road above the public beach',
    ...
    stayOptions: [
      ...
      'Crystals Beach Resort (Radisson Individuals)',
    ...
    nearbyAttractions: [
      ...
      'The Legend & The Links golf (Constance Belle Mare Plage)',
