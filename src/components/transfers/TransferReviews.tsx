  ...
  return (
    <section className="mt-12 border-t border-ink/10 pt-9">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h2 className="text-[22px] font-extrabold tracking-tight text-ink">See why guests love us</h2>
          <p className="mt-1.5 flex flex-wrap items-center gap-x-2 gap-y-1 text-[14px] text-ink/75">
            ...
            <span className="text-ink-muted">
              from {reviewStats.total.toLocaleString('en-GB')} reviews · TripAdvisor {reviewStats.tripadvisor.rating.toFixed(1)} · Google{' '}
