  ...
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(180deg,#15a3a8 0%,#0E8C92 32%,#0B5C63 64%,#06343a 100%)' }}
      />
      {/* soft gold sun glow, top-right */}
      <div
        className="absolute inset-0"
        style={{ background: 'radial-gradient(circle at 80% 16%, rgba(233,185,73,0.42), rgba(233,185,73,0) 42%)' }}
      />
      {/* faint light shimmer below the sun */}
      <div
        className="absolute inset-0"
        style={{ background: 'radial-gradient(120% 55% at 80% 18%, rgba(255,255,255,0.12), transparent 52%)' }}
      />
      ...
      <div
        className="absolute inset-0"
        style={{ background: 'linear-gradient(180deg, transparent 44%, rgba(4,30,34,0.55) 78%, rgba(4,24,28,0.78) 100%)' }}
      />
...
function Wave({
  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 2880 210" preserveAspectRatio="none" style={{ display: 'block', width: '100%', height: '100%' }}>
        <path
