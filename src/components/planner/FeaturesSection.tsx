...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    icon: (
      <>
        <path
          d="M12 3a5 5 0 0 1 5 5v2a5 5 0 0 1-10 0V8a5 5 0 0 1 5-5Z"
          stroke="#F76C5E"
          strokeWidth={2}
        />
        <path
    ...
    <section id="how-zilai-works" className="mx-auto max-w-shell scroll-mt-24 px-[22px] pb-2 pt-14">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="mb-1.5 max-w-[560px] sm:col-span-2 lg:col-span-3">
          <p className="mb-1.5 text-[13px] font-bold uppercase tracking-[0.04em] text-teal">
            {t('How ZilAi works')}
          </p>
        ...
        {FEATURES.map((f) => (
          <div
            key={f.title}
            className="rounded-[18px] border border-[#EEF4F3] bg-white p-[22px] shadow-[0_10px_30px_rgba(10,46,54,.05)]"
          >
