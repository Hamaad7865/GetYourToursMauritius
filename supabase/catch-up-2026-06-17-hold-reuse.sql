-- ============================================================================
-- Belle Mare Tours — hold-reuse catch-up (2026-06-17)
-- Adds api_create_hold + api_book hold reuse (hold on Continue, no double-hold).
-- Idempotent — safe to run more than once. Run AFTER the custom-itinerary catch-up.
-- ============================================================================
