...
-- ==================== 20260617220000_admin_atomic_writes.sql ====================
...
-- ==================== 20260618010000_booking_replay_guard_fix.sql ====================
...
-- ==================== 20260618030000_places_cache.sql ====================
...
-- ==================== 20260622000000_profile_dob.sql ====================
...
-- ==================== 20260719120000_audit_fixes.sql ====================
...
-- ==================== 20260720000000_activity_transport_pricing.sql ====================
...
-- ==================== 20260720120000_hold_release_authz.sql ====================
...
-- ==================== 20260721000000_booking_dropoff.sql ====================
...
-- ==================== 20260722000000_payment_not_payable_guard.sql ====================
...
-- ==================== 20260722120000_generic_rate_limit.sql ====================
...
-- ==================== 20260723000000_payment_charge.sql ====================
...
-- ==================== 20260724000000_booking_receipt.sql ====================
...
-- ==================== 20260725000000_payment_charge_guard.sql ====================
...
-- ==================== 20260726000000_mark_refunded.sql ====================
...
-- ==================== 20260728000000_activity_min_advance.sql ====================
...
-- ==================== 20260729000000_payment_checkout_id.sql ====================
...
-- ==================== 20260732000000_airport_transfer_booking_fields.sql ====================
...
-- ==================== 20260733000000_cancel_booking.sql ====================
...
-- ==================== 20260734000000_hotel_transfers.sql ====================
...
-- ==================== 20260735000000_transfer_service_date.sql ====================
...
-- ==================== 20260736000000_peach_safe_booking_ref.sql ====================
...
-- ==================== 20260737000000_booking_history.sql ====================
...
-- ==================== 20260739000000_notifications_feed.sql ====================
...
-- ==================== 20260740000000_notifications_unread_count.sql ====================
...
-- ==================== 20260741000000_transfers_read.sql ====================
...
-- ==================== 20260743000000_activity_filters.sql ====================
...
-- ==================== 20260744000000_account_profile.sql ====================
...
-- ==================== 20260745000000_hotel_transfer_coords.sql ====================
...
-- ==================== 20260746000000_transfer_pickup_time_and_quote_coords.sql ====================
...
-- ==================== 20260747000000_rental_fleet.sql ====================
...
-- ==================== 20260748000000_price_age_bands.sql ====================
...
-- ==================== 20260749000000_activity_sort.sql ====================
...
-- ==================== 20260750000000_from_price_exclude_free.sql ====================
...
-- ==================== 20260751000000_from_price_adult_for_agebands.sql ====================
...
-- ==================== 20260752000000_option_duration_start.sql ====================
...
-- ==================== 20260800000000_reorder_category_scope.sql ====================
...
-- ==================== 20260800000001_payment_reuse_checkout.sql ====================
...
-- ==================== 20260801000000_private_option.sql ====================
...
-- ==================== 20260802000000_from_price_private_base.sql ====================
...
-- ==================== 20260803000000_search_private_included.sql ====================
...
-- ==================== 20260804000000_owner_booking_alerts.sql ====================
...
-- ==================== 20260805000000_sweep_fixes.sql ====================
...
-- ==================== 20260806000000_security_lockdown.sql ====================
...
-- ==================== 20260807000000_lockdown_public_revoke.sql ====================
...
-- ==================== 20260808000000_api_book_server_only.sql ====================
...
-- ==================== 20260809000000_api_book_fallback_hold_owner.sql ====================
...
-- ==================== 20260811000000_activity_content_defaults.sql ====================
...
-- ==================== 20260812000000_payment_hold_hardening.sql ====================
...
-- ==================== 20260814000000_lock_definer_execute.sql ====================
...
-- ==================== 20260816000000_erase_pickup_dropoff.sql ====================
...
-- ==================== 20260817000000_whatsapp_owner_alerts.sql ====================
...
-- ==================== 20260818000000_lock_receipt_pending_execute.sql ====================
...
-- ==================== 20260819000000_weather_disruption_reschedule.sql ====================
...
-- ==================== 20260823000000_review_invite_context.sql ====================
...
-- ==================== 20260824000000_belle_mare_activity_grouping.sql ====================
...
-- ==================== 20260825000000_review_invites_completed_status.sql ====================
...
-- ==================== 20260826000000_owner_alert_customer_phone.sql ====================
...
-- ==================== 20260828000000_review_invites_p_arg.sql ====================
...
-- ==================== 20260830000000_charge_in_mur.sql ====================
...
-- ==================== 20260901000200_reclassify_stub_translations.sql ====================
...
-- ==================== 20260901000300_booking_locale.sql ====================
...
insert into session_occurrences (activity_option_id, operator_id, starts_at, ends_at, capacity) select o.id, a.operator_id, gs, gs + interval '4 hours', 20 from activity_options o join activities a on a.id = o.activity_id cross join generate_series((((now() at time zone 'Indian/Mauritius')::date + 1)::timestamp + time '09:00') at time zone 'Indian/Mauritius', (((now() at time zone 'Indian/Mauritius')::date + 7)::timestamp + time '09:00') at time zone 'Indian/Mauritius', interval '1 day') gs where exists (select 1 from activity_option_prices p where p.activity_option_id = o.id) on conflict (activity_option_id, starts_at) do nothing;
