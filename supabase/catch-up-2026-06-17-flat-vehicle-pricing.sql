-- ============================================================================
-- Belle Mare Tours — flat vehicle-pricing catch-up (2026-06-17)
-- Sedan EUR70 / SUV EUR85 / Family EUR85 / Van EUR125 / Coaster EUR225, capped at 25.
-- One FLAT price per vehicle bracket (replaces the per-4 rule). Idempotent.
-- Run AFTER the hold-reuse catch-up.
-- ============================================================================
