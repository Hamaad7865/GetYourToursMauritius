-- ============================================================================
-- Belle Mare Tours — pickup-location catch-up (2026-06-17)
-- Adds bookings.pickup_location + persists the checkout pickup via api_book, and
-- exposes it from booking_json. Idempotent — safe to run more than once.
-- Run AFTER the hold-reuse catch-up (this redefines that api_book + booking_json).
