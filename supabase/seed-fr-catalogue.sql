...
select
  ...
  'Profitez d’une excursion exclusive et privée en speedboat au départ de Grand Baie vers Flat Island, Gabriel Island et Gunner’s Coin. Naviguez à votre propre rythme, découvrez des lagons aux eaux cristallines, faites du snorkeling dans une mer foisonnante de vie marine et détendez-vous sur des plages immaculées. Votre expérience comprend un délicieux déjeuner BBQ servi sur l’île, ainsi qu’une sélection de boissons rafraîchissantes tout au long de la journée. Idéal pour les couples, les familles ou les petits groupes en quête d’une aventure insulaire personnalisée.',
  'Profitez d’une excursion exclusive et privée en speedboat à la découverte de trois îles du Nord de Maurice. Au départ de Grand Baie, vous naviguerez pendant environ 45 minutes jusqu’à Flat Island, où vous pourrez vous détendre sur la plage, nager dans des eaux cristallines ou faire du snorkeling dans de magnifiques lagons.

Explorez la flore et la faune tropicales uniques de l’île, aussi bien sur terre que sous la surface. Après un délicieux déjeuner BBQ servi sur l’île, poursuivez votre aventure privée jusqu’à Gabriel Island, où vous pourrez profiter de ses plages immaculées et de sa beauté naturelle à votre propre rythme. La journée se termine par une dernière séance de snorkeling près de Gunner’s Coin, réputé comme l’un des plus beaux sites de snorkeling et de plongée au large de la côte Nord de Maurice.',
  'Cap Malheureux',
  array[
    'Flat Island : détente, snorkeling et déjeuner BBQ',
    'Gabriel Island : exploration de l’île',
    'Gunner’s Coin : snorkeling sur l’un des plus beaux sites de plongée au large du Nord de Maurice'
  ]::text[],
  array[
    'Salades et pain au beurre à l’ail',
    'BBQ : poulet, poisson, saucisse',
