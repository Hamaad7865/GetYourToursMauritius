-- ============================================================================
-- Belle Mare Tours — child-seats catch-up (2026-06-17)
-- Adds bookings.child_seats + the "first free, €6 each extra" charge computed in
-- api_book, and exposes childSeats from booking_json. Idempotent — safe to run more
-- than once. Run AFTER the pickup-location catch-up (redefines that api_book + booking_json).
