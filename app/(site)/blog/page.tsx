...
function PostCard({ p }: { p: Post }) {
  return (
    ...
    >
      ...
      <h2 className="mt-2 text-[18px] font-extrabold leading-snug text-ink group-hover:text-teal">{p.title}</h2>
...
export default function BlogIndexPage() {
  ...
  return (
    <>
      ...
      <InfoPage eyebrow="Mauritius travel blog" title="Guides, tips & itineraries for Mauritius" intro={DESCRIPTION}>
